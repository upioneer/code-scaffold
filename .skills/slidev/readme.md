...
* **Advanced Configuration Workflows**: Manages underlying framework settings by directly interacting with Vite configurations, Vue setup files, and custom UnoCSS definitions.
* **Export & Deployment Orchestration**: Executes Playwright-driven CLI commands to generate PDF, PNG, or PPTX assets while navigating known timeout issues, and guides static SPA deployments (Vercel, Netlify, GitHub Pages) with correct base path handling.
