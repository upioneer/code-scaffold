...
<head>
    ...
    <style>
        ...
        .hero { max-width: 800px; text-align: left; }
        h1 { font-size: 6rem; margin: 0 0 1rem 0; color: white; letter-spacing: -3px; line-height: 1; text-transform: uppercase; mix-blend-mode: overlay; }
        p { font-size: 1.5rem; color: rgba(255,255,255,0.9); margin: 0; max-width: 500px; line-height: 1.4; text-shadow: 0 2px 10px rgba(0,0,0,0.5); }
    </style>
</head>
<body>
    <canvas id='c'></canvas>
