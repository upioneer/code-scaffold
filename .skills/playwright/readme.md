...
* **Mobile Viewport & Overflow Testing**: Automatically asserts zero horizontal overflow and rendering integrity across mobile (iPhone 14, Pixel 7), tablet (iPad), and desktop viewports via `scripts/test-responsive.js`.
