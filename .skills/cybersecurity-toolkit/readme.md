...
* **Comprehensive SAST Secret Engine:** Parses 12+ programming languages to detect high-entropy keys (OpenRouter, Claude, AWS, Azure, GCP, Stripe, GitHub, etc.) and explicit PII/AD references (LDAP strings, UPNs, SSNs).
