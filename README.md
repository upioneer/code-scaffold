...
* **Agent Skills**: Pre-configured integration snippets (Excalidraw, Firebase, GitHub, Marp, Mermaid, Node, Resend, Supabase, Telegram) deployed to their designated `target` paths.
