...
Set the project and space ID directly in your [TrainingArguments](https://huggingface.co/docs/transformers/v5.12.0/en/main_classes/trainer#transformers.TrainingArguments):
